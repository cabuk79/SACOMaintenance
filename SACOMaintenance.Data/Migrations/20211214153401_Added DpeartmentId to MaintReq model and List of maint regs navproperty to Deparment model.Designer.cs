...
namespace SACOMaintenance.Data.Migrations
{
    ...
    [Migration("20211214153401_Added DpeartmentId to MaintReq model and List of maint regs navproperty to Deparment model")]
    partial class AddedDpeartmentIdtoMaintReqmodelandListofmaintregsnavpropertytoDeparmentmodel
    {
            ...
            modelBuilder.Entity("SACOMaintenance.Common.ModelDB.AuthorizationRequest", b =>
                {
                    ...
                    b.Property<string>("CommentRejection")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SACOMaintenance.Common.ModelDB.MaintRequestInitiation", b =>
                {
                    ...
                    b.HasOne("SACOMaintenance.Common.ModelDB.Department", "Department")
                        .WithMany("Maintreqs")
