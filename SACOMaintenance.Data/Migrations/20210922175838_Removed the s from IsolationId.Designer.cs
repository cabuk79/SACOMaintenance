...
namespace SACOMaintenance.Data.Migrations
{
    ...
    [Migration("20210922175838_Removed the s from IsolationId")]
    partial class RemovedthesfromIsolationId
    {
            ...
            modelBuilder.Entity("SACOMaintenance.Common.ModelDB.IsolationMaintRequestInitiation", b =>
                {
                    ...
                    b.HasKey("IsolationId", "MaintReqInitationListId");

                    b.HasIndex("MaintReqInitationListId");
            ...
            modelBuilder.Entity("SACOMaintenance.Common.ModelDB.IsolationMaintRequestInitiation", b =>
                {
                    b.HasOne("SACOMaintenance.Common.ModelDB.Isolation", null)
                        .WithMany()
                        .HasForeignKey("IsolationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SACOMaintenance.Common.ModelDB.MaintRequestInitiation", null)
                        .WithMany()
                        .HasForeignKey("MaintReqInitationListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
