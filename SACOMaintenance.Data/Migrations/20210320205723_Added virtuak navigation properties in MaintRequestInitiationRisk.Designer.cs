...
namespace SACOMaintenance.Data.Migrations
{
    ...
    [Migration("20210320205723_Added virtuak navigation properties in MaintRequestInitiationRisk")]
    partial class AddedvirtuaknavigationpropertiesinMaintRequestInitiationRisk
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SACOMaintenance.Common.ModelDB.MaintRequestInitiationRisk", b =>
                {
                    b.Property<int>("MaintRequestInitiationRiskId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int?>("MaintRequestInitiationId1")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("RiskRiskId")
                        .HasColumnType("int");

                    b.Property<int?>("RisksId")
                        .HasColumnType("int");

                    b.HasKey("MaintRequestInitiationRiskId");

                    b.HasIndex("MaintRequestInitiationId");

                    b.HasIndex("MaintRequestInitiationId1");
            ...
            modelBuilder.Entity("SACOMaintenance.Common.ModelDB.MaintRequestInitiationRisk", b =>
                {
                    ...
                    b.HasOne("SACOMaintenance.Common.ModelDB.MaintRequestInitiation", null)
                        .WithMany()
                        .HasForeignKey("MaintRequestInitiationId1");

                    b.HasOne("SACOMaintenance.Common.ModelDB.Risk", "Risk")
                        .WithMany()
